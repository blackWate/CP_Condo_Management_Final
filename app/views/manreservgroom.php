    ...
    <legend>Reservations</legend>
	 <br>
        ...
        <ul  class="nav nav-pills">
		            <li id="g" class=""><button type="submit" class="btn btn-primary" formaction="manreservgroom">Guest Room</a></button></li>
		            ...
		            <div class="tab-pane active" style="margin-top: -40px;" id="1a">
		                    <table class="table table-striped table-hover table-responsive">
		                        ...
		                        echo'<tr >
		                              ...
		                              <td>'.$grData->duration.' '.$day.'</td>
		                              <form action="manreservgroom" method="post">
		                              <td>'.$fee.' $<br>
