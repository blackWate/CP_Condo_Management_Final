...
echo '  
   ...
   <div  class="container dash1 col-xs-12  col-lg-12   col-md-12 pull-left"> 
   <br>
	 <legend>Reservations</legend>
        <form method="post">
        <ul  class="nav nav-pills">
		            <li id="g" class=""><button type="submit" class="btn btn-default" formaction="manreservgroom">Guest Room</a></button></li>
		            <li id="p" class="active"><button type="submit" class="btn btn-primary" formaction="manreservproom">Party Room</a></button></li>
		            <li id="e" class=""><button type="submit" class="btn btn-default" formaction="manreservelevator">Elevator</a></button></li>
		        </ul>
		  </form>     
		            ...
		            <div class="tab-pane active" style="margin-top: -40px;" id="1a">
		                    <table class="table table-striped table-hover table-responsive">
		                        ...
		                        echo'<tr >
		                              ...
		                              <td>'.$grData->starttime.'-'.$grData->endtime.'</td>
		                              <form action="manreservproom" method="post">
		                              <td>'.$grData->fee.' $<br>
			                              <select name="feeIsPaid" class="btn-info" data-style="btn-info">
		                              ...
		                              <td>
			                                <button  type="submit" formaction="manreservgroom"  class="btn btn-warning chat glyphicon glyphicon-comment" name="chat" value="chat" data-toggle="tooltip" data-placement="top" title="Chat" reservetype="reservations" reserveid='.$grData->reservationid.'></button>
		            ...
		            <div class="tab-pane" style="margin-top: -40px;" id="3a">
		                    <table class="table table-striped table-hover table-responsive">
		                          ...
		                          foreach ($data['manGRoomcp'] as $grData) {
		                            ...
		                            $day = ($grData->duration>1) ? 'days' : 'day' ;
		                           $username=$grData->firstname.' '.$grData->lastname;
		                        echo'<tr >
		                              <th scope="row">'.$x.'</th>
		                              <td>'.$grData->reservationid.'<br><strong>'.$username.'</strong></td>
